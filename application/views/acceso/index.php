					...
					<div class="col-md-6">
						...
						<?php if(IS_DEMO == 1): ?>
							<div class="alert alert-info text-center">
								<blink>Bienvenido a la versión de prueba de <b>Sigal</b>.<br/>Ingresa con el <b>usuario</b> <u>demo</u>, y <b>contraseña</b> <u>demo</u>.</blink>
							</div>
						<?php endif; ?>
						<div class="panel panel-default">
						  <div class="panel-heading">
						  		Ingrese los datos solicitados <b class="pull-right"><?php echo SOFTWARE_VERSION; ?></b>
						  </div>
